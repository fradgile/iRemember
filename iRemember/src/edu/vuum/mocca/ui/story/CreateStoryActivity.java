...
//			Toast.makeText(getActivity(),"SD Card not mounted.", Toast.LENGTH_LONG).show();			
			return null;
		}
	...
	private void launchSoundIntent() {
		...
		Intent sound = new Intent(this, SoundRecordActivity.class);		
		...
		sound.putExtra(SoundRecordActivity.EXTRA_OUTPUT, soundFile.getAbsolutePath());		
		
		// TODO - Start a new activity for result, using the new intent and the request
		// code MIC_SOUND_REQUEST
		startActivityForResult(sound, MIC_SOUND_REQUEST);
	}
	...
	private void launchCameraIntent() {
		...
		image.putExtra(MediaStore.EXTRA_OUTPUT, fragment.imagePath);		
	
		// TODO - Start a new activity for result, using the new intent and the request
		// code CAMERA_PIC_REQUEST		
		startActivityForResult(image, CAMERA_PIC_REQUEST);		
	...
	private void launchVideoCameraIntent() {
		...
		// TODO - Add the filename to the Intent as an extra. Use the Intent-extra name
		// from the MediaStore class, EXTRA_OUTPUT
		video.putExtra(MediaStore.EXTRA_OUTPUT, fragment.fileUri);		
		...
		startActivityForResult(video, CAMERA_VIDEO_REQUEST);
